...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($name == '' || $id_no == ''){
        ...
        if(mysqli_num_rows($querry)>0)
        {
          ...
          $sign = $uploaddir . basename($_FILES['sign']['name']);
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `cards`(`name`, `id_no`,`course`, `email`, `phone`, `address`,`dob` , `jdate`, `exp_date`, `image`, `sign`) VALUES ('$name','$id_no','$course','$email','$phone','$address','$dob', '$jdate', '$exp_date' , '$uploadfile', '$sign')"; 
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <select name="course" class="form-control">
          ...
          <option value="I.Sc">Science (Intermediate)</option>
          <option value="I.A">Arts(Intermediate)</option>
    ...
    <div class="form-row">
      ...
      <div class="form-row">
        ...
        <input type="date" name="dob" class="form-control">
                ...
                <div class="form-group col-md-3">
        <label class="my-2" for="joinedDate">Date Of Joining</label>

        <input type="date" name="jdate" class="form-control">
      </div>
      <div class="form-group col-md-2">

        <label for="inputValid">Valid Till</label>
