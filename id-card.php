...
<div class='container-2'>
    ...
    <div class='box-2'>
        <h2>$name</h2>
        <p style='font-size: 14px;'>E-Mail:-<span class='phn'>$email</span></p>
    </div>
    <div class='box-3'>
    <p class='idn'>ID:-$id_no</p>
        <img src='assets/images/tnb.png' alt=''>
    </div>
</div>
...
<div class='container-3'>
    ...
    <div class='info-4'>
       ...
       <img src='$sign'/>
            <br>
            <hr>
            <p style='font-size:12px;' class='sign'>Your Signature</p>
        </div>
    </div>
    <!-- id card end -->
";
...
/* box-shadow: 0 1px 10px rgb(146 161 176 / 50%); */
/* border-radius: 10px; */
background-image: url(assets/images/ris.png);
overflow: hidden;
